...
import {
  getSummaryReport,
  getEffortByTagForDoughnutChart,
} from './Report/selectors.js'
          ...
          <div>
            <p>
              ...
              <span className='total-effort'>
                {this.props.report.totalEffort}
              </span>
            </p>
            <BarChart
              labels={this.props.report.effortByDayForBarChart.labels}
              data={this.props.report.effortByDayForBarChart.data}
            />
            ...
            >
              <DoughnutChart
                labels={this.props.doughnutChart.labels}
                datasets={this.props.doughnutChart.datasets}
              />
            </div>
          </div>
        ) : (
